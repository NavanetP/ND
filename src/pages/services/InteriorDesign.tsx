              ...
              {[
                {
                  ...
                  description: "We listen to your lifestyle, aesthetic goals, and preferences.",
                },
                {
                  step: "2",
                ...
                },
                {
                  ...
                  description: "You receive 3D renders, color palettes, and finish plans.",
                },
                {
                  step: "4",
                ...
                },
                {
                  ...
                  description: "Either with your contractor or through our execution services.",
                },
              ].map((process, index) => (
      ...
      <section className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 bg-gradient-to-r from-cyan-500 to-cyan-500">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-cyan-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4 reveal">
            We combine creativity with functionality to give you timeless interiors.
          </p>
