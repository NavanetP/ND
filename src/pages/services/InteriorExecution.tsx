      ...
      <section className="bg-gradient-to-br from-cyan-600 via-cyan-500 to-cyan-400 py-10 xs:py-12 sm:py-14 md:py-16 lg:py-20 px-4 xs:px-6 sm:px-8 md:px-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-white/90 text-justify xs:text-center
            ...
            We turn your ideas into spaces you can live in — on-site, in
            person, with attention to detail. From raw walls to finished homes
            or offices, Nitham Designs manages execution with expertise and
            commitment.
          </p>
          ...
          <div className="flex justify-center">
            <div className="relative bg-white/20 backdrop-blur-sm border border-white/40
              ...
              <p className="relative z-10
                ...
                Designs Brought to Life With Precision
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-10 px-4 sm:px-6">
        <div className="container mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black text-center mb-8 sm:mb-12 reveal">
            Benefits of Our Interior Execution Service
          </h2>
          <div className="max-w-8xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
              {[
                ...
                { icon: Shield,       text: "Quality-controlled carpentry and modular work" },
                { icon: Users,        text: "Single-point coordination for all vendors" },
                { icon: Target,       text: "Site supervision at every stage" },
                { icon: CheckCircle,  text: "Transparent billing & progress updates" },
              ].map((benefit, index) => {
              ...
              {[
                {
                  ...
                  description: "BoQ confirmation, site preparation, and timeline setup.",
                },
                {
                  step: "2",
                  title: "Worksite Management",
                  description: "On-site team with daily updates.",
                },
                {
                  step: "3",
                  title: "Material Coordination",
                  description: "We source and deliver pre-approved materials.",
                },
                {
                  step: "4",
                  title: "Final Touches & Styling",
                  description: "Soft furnishings and decor setup.",
                },
              ].map((process, index) => (
      ...
      <section className="py-8 sm:py-10 px-4 sm:px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
            {[
              {
                question: "Will you help us source materials and finishes during execution?",
                answer:
                  "Yes, our team can assist in sourcing high-quality materials, furnishings, and finishes that align with your design plan and budget. We also coordinate with trusted vendors to ensure timely delivery and installation.",
              },
              {
                question: "Do you work with third-party designers' plans?",
                answer: "Yes, if drawings are clear, we can execute external designs.",
              },
              {
                question: "How do you maintain quality?",
                answer: "Through a vetted vendor network and strict design fidelity.",
              },
            ].map((faq, index) => (
              <div
                key={index}
...
export default InteriorExecution;
