  ...
  <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-cyan-500 rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
        <Hammer className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
              <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg reveal">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-100 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 mx-auto">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-500" />
                </div>
              ...
              <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg reveal">
                ...
                <h3 className="font-bold text-black text-sm sm:text-base text-center">
                  Quality-controlled carpentry and modular work
                </h3>
              </div>
              <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg reveal">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-100 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 mx-auto">
                ...
                <h3 className="font-bold text-black text-sm sm:text-base text-center">
                  Single-point coordination for all vendors
                </h3>
              </div>
              <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg reveal">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-100 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 mx-auto">
                ...
                <h3 className="font-bold text-black text-sm sm:text-base text-center">
                  Site supervision at every stage
                </h3>
              </div>
              <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg reveal">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-100 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 mx-auto">
                ...
                <h3 className="font-bold text-black text-sm sm:text-base text-center">
                  Transparent billing & progress updates
                </h3>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "BoQ confirmation, site preparation, and timeline setup.",
                },
                {
                  step: "2",
        ...
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
            {[
              {
                question:
                  "Will you help us source materials and finishes during execution?",
                answer:
              ...
              },
              {
                ...
                answer:
                  "Yes, if drawings are clear, we can execute external designs.",
              },
              {
                question: "How do you maintain quality?",
                answer:
                  "Through a vetted vendor network and strict design fidelity.",
              },
            ].map((faq, index) => (
              <div
                key={index}
