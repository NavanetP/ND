...
import p4444 from "../../Residential Interior Design/Mr.Vijaykumar residence/04.jpg";
        ...
        <div className="container mx-auto">
          ...
          <div className="max-w-10xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
              {[
                { icon: Leaf,        text: "Improve aesthetics and air quality" },
                { icon: Sun,         text: "Climate-smart plant selection" },
                { icon: Trees,       text: "Low-maintenance designs" },
                { icon: Flower,      text: "Zones for play, peace, and function" },
                { icon: CheckCircle, text: "Integration with architecture and interiors" },
              ].map((benefit, index) => {
            ...
            <div className="space-y-6 sm:space-y-8">
              {[
                ...
                },
                {
                  ...
                  description: "We finalize textures, tiles, planters, and plant types.",
                },
                {
                  step: "4",
                  title: "Execution Planning or Support",
                  description: "We offer install guidance or manage full installation.",
                },
              ].map((process, index) => (
            ...
            {[
              {
                ...
                answer: "We don't offer ongoing maintenance, but we give care guides and planning.",
              },
              {
                question: "Can you work with existing balconies/terraces?",
                answer: "Yes — we specialize in transforming small urban outdoor spaces too.",
              },
            ].map((faq, index) => (
              <div
                key={index}
